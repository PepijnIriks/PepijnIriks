...
### 🔍 Cybersecurity Research Intern @ Conclusion Enablement
Ik ben een 3e jaars Cybersecurity student aan **Fontys Hogeschool**. Tijdens mijn Semester 5 stage doe ik onderzoek naar de synergie tussen **Open-Source AI** en **Cyber Defense**.

- 🔭 **Stage-onderzoek:** Optimalisatie van security workflows met free-to-use AI tools.
- 🧪 **Focus:** AI-driven Vulnerability Scanning, Log Analysis & Threat Intelligence.
- 🎓 **Opleiding:** Fontys ICT (S5).
- 🛠️ **Tools in onderzoek:** Hugging Face Models, Ollama, LangChain & Security Onion.
